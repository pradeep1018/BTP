...
if __name__=='__main__':
    ...
    cdloss=False, cdloss_weight=cdloss_weight, scloss=False, scloss_weight=scloss_weight)

    loss_cl, train_auc_cl, val_auc_cl = main(train_csv, valid_csv, num_epochs, batch_size,
    cdloss=True, cdloss_weight=cdloss_weight, scloss=True, scloss_weight=scloss_weight)
